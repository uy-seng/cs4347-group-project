...
LOAD DATA INFILE '/var/lib/mysql-files/data/customer.csv'
INTO TABLE Customer
...
LOAD DATA INFILE '/var/lib/mysql-files/data/administrator.csv'
INTO TABLE Administrator
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(customer_id, first_name, last_name, email, SSN, password);

-- Load data into Account table
-- Assuming account.csv contains: owner_id,account_status,balance,account_history
LOAD DATA INFILE '/var/lib/mysql-files/data/account.csv'
INTO TABLE Account
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(owner_id, account_status, balance, account_history);
...
LOAD DATA INFILE '/var/lib/mysql-files/data/transaction.csv'
...
LOAD DATA INFILE '/var/lib/mysql-files/data/bank_withdrawal.csv'
INTO TABLE Bank_Withdrawal
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(account_id, name, date, amount, new_balance, transaction_type);
...
LOAD DATA INFILE '/var/lib/mysql-files/data/bank_deposit.csv'
INTO TABLE Bank_Deposit
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(account_id, name, date, amount, new_balance, transaction_type);
...
LOAD DATA INFILE '/var/lib/mysql-files/data/bank_transfer.csv'
INTO TABLE Bank_Transfer
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
(account_id, name, date, amount, new_balance, transaction_type, from_account, to_account);
